...
A [timoni.sh](http://timoni.sh) module for deploying timoni-bug to Kubernetes clusters.
...
```shell
timoni -n default apply timoni-bug oci://<container-registry-url>
```
...
```shell
timoni -n default delete timoni-bug
```
